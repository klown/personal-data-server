...
| loginToken        | String    | __Required__ | None              | The token generated by the Prefernces Server and returned to the Edge Proxy server for accessing the user's preferences.  It has the same expiration as this `accessToken` |
