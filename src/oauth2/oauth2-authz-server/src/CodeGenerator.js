...
fluid.defaults("fluid.oauth2.codeGenerator", {
    gradeNames: ["fluid.component"],
    invokers: {
        generateAccessToken: "fluid.oauth2.codeGenerator.generateAccessToken"
    }
});

fluid.oauth2.codeGenerator.generateAccessToken = function () {
